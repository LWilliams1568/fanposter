...
const App = () => {
	...
	return (
		<div className='container-fluid'>
			<div className='row d-flex align-items-center mt-4 mb-4 movie-app fixMargin smaller'>
			...
			<div className='row d-flex align-items-center mt-4 mb-4 movie-app smaller'>
